...
JIJI       JIJI Press
AID   Autmated Intelligence on Demand
...
BECO  Bloomberg Economics (-> 'Model' shows Charts with good visuals)

<先物>
OMON  OptionMonitor
COT   CFTC Ticker
PCS   CommodityDefaults
MDM   MarketDepthMonitor
EXC   Exchange Privileges (subscribed or not)
 
<Equities (including ETF)>
AQR     Top Trade
QR      Quote Recap
QM      Quote Montage (Market Share for each exchange)
TSM     Trade Summary Matruix
MBTRR   Monitoring Block Trade Recap
VBAR    Volume Dimension Bars
HP      Historical Price Table
HCP     HP with % Chg
HCPI    Historical OHLC with % Chg
OMON    Option Monitor
...
DPDF    Corporate Action Setting (Adjust historical pricing to reflect dividends, etc.)
KI      Insight
...
<Commodity>
CPFC    Commodity Price Forecasts    <- Future Price, Forcasts from Broker
